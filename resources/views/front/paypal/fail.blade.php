...
@section('content')
    ...
    <ul class="bread-crumb">
                    ...
                    <li class="is-marked">
                        <a href="#">Payment {{ __("translation.Failed")}}!</a>
                    </li>
                </ul>
    <!-- Page Introduction Wrapper /- -->
    <!-- Cart-Page -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12" align="center">
                    <h3>{{ __("translation.YOUR Payment Failed")}}!</h3>
                    <p>{{ __("translation.Please try again after some time and contact us if there is any enquiry")}}.</p>
                </div>
            </div>
        </div>
    </div>

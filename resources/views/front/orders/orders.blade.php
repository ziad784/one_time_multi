...
@section('content')
    ...
    <ul class="bread-crumb">
        ...
        <li class="is-marked">
            <a href="#">{{ __("translation.Orders")}}</a>
        </li>
    </ul>
    <!-- Page Introduction Wrapper /- -->
    <!-- Cart-Page -->
            ...
            <div class="row">
                <table class="table table-striped table-borderless">
                    <tr class="table-danger">
                        <th>{{ __("translation.Order ID")}}</th>
                        <th>{{ __("translation.Ordered Products")}}</th> {{-- We'll display products codes --}}
                        <th>{{ __("translation.Payment Method")}}</th>
                        <th>{{ __("translation.Grand Total")}}</th>
                        <th>{{ __("translation.Created on")}}</th>

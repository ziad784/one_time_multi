...
<br>
    ...
    <section class="section-maker">
        <div class="container home_items_cont"  >
            ...
            <div class="tab-pane active show fade" id="men-latest-products">
                <label for="" class="product_label">{{ __("translation.New Arrivals")}} </label>
                <div class="slider-fouc">
                        ...
                        <div class="item">
                            <div class="image-container">
                                ...
                                {{-- <div class="item-action-behaviors">
                                    ...
                                    <a class="item-addCart" href="{{ url('product/' . $product['id']) }}">{{ __("translation.Add to Cart")}}</a>
                                </div> --}}
                            </div>
            ...
            <div class="tab-pane active show fade" id="men-latest-products">
                <label for="" class="product_label">{{ __("translation.Best Sellers")}}</label>
                <div class="slider-fouc">
                    <div class="products-slider owl-carousel exclusive_slider" data-item="4">
            ...
            <div class="tab-pane active show fade" id="men-latest-products">
                <label for="" class="product_label">{{ __("translation.Discounted Products")}}</label>
                <div class="slider-fouc">
                    <div class="products-slider owl-carousel exclusive_slider" data-item="4">
                    
                      {{-- Show the 'Discounted Products' products. Check the index() method in IndexController.php --}} 
                            ...
                            <div class="item">
                                <div class="image-container">
                                    ...
                                    {{-- <div class="item-action-behaviors">
                                        ...
                                        <a class="item-mail" href="javascript:void(0)">{{ __("translation.Mail")}}</a>
                                        <a class="item-addwishlist" href="javascript:void(0)">{{ __("translation.Add to Wishlist")}}</a>
                                        <a class="item-addCart" href="{{ url('product/' . $product['id']) }}">{{ __("translation.Add to Car")}}t</a>
                                    </div> --}}
                                </div>
                                <div class="item-content">
                                    <div class="what-product-is">
            ...
            <div class="tab-pane active show fade" id="men-latest-products">
                <label for="" class="product_label">{{ __("translation.Featured Products")}}</label>
                <div class="slider-fouc">
                    <div class="products-slider owl-carousel exclusive_slider" data-item="4" >
                           {{-- Show the 'Best Seller' products. Check the index() method in IndexController.php --}} 

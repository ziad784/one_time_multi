...
<div class="mini-cart-wrapper2 hide_filter" id="filter_poppup">
    <div class="mini-cart2">
        <div class="mini-cart-header2">
       
            <button type="button" class="button ion ion-md-close" id="mini-cart-close2"></button>
        </div>
        <ul class="mini-cart-list2">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12">
                ...
                @if (!isset($_REQUEST['search']))
                    ...
                    <div class="facet-filter-associates">
                        <h3 class="title-name">{{ __("translation.Size")}}</h3>
                    ...
                    @endphp
                    <div class="facet-filter-associates">
                        <h3 class="title-name">{{ __("translation.Color")}}</h3>
                        <form class="facet-form" action="#" method="post">
                            <div class="associate-wrapper">
                    ...
                    @endphp
                    <div class="facet-filter-associates">
                        <h3 class="title-name">{{ __("translation.Brand")}}</h3>
                        <form class="facet-form" action="#" method="post">
                            <div class="associate-wrapper">
                    ...
                    <div class="facet-filter-associates">
                        <h3 class="title-name">{{ __("translation.Price")}}</h3>
                        <form class="facet-form" action="#" method="post">
                            <div class="associate-wrapper">
                                ...
                                @foreach ($prices as $key => $price)
                                    ...
                                    <label class="label-text" for="price{{ $key }}">ريال {{ $price }}
                                    </label>
                                @endforeach
                            </div>
                        </form>
...
<script>
    const filter_poppup = document.getElementById("filter_poppup");
    const closeBtn = document.getElementById("mini-cart-close2");
    const responsivefilter = document.getElementById("responsive-filter");
    closeBtn.addEventListener("click",()=>{
        filter_poppup.classList.add("hide_filter")
        filter_poppup.classList.remove("show_filter")
    })
    responsivefilter.addEventListener("click",()=>{
        filter_poppup.classList.add("show_filter")
        filter_poppup.classList.remove("hide_filter")
    })
</script>

<div class="col-lg-3 col-md-3 col-sm-12 normal_filter">
    <!-- Fetch-Categories-from-Root-Category  -->

...
@section('content')
    ...
    {{-- <ul class="bread-crumb">
        ...
        <li class="is-marked">
            <a href="listing.html">{{ __("translation.Shop")}}</a>
        </li>
    </ul> --}}
    <!-- Page Introduction Wrapper /- -->

    <!-- Shop-Page -->
    <div class="page-shop u-s-p-t" >
        <div class="container">
            <!-- Shop-Intro -->
            <div class="shop-intro">
                <ul class="bread-crumb">
                    <li class="has-separator" style="font-size: 17px">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    <div class="page-bar clearfix">
                            ...
                            <form name="sortProducts" id="sortProducts"> {{-- Absence of the "action" attribute means submitting the <form> data to the same page, and absence of "method" attribute means the <form> uses the default "method" which is "GET" --}}
                                ...
                                <div class="toolbar-sorter">
                                    <div class="select-box-wrapper">
                                        <label class="sr-only" for="sort-by">{{ __("translation.Sort By")}}</label>
                                        <select name="sort" id="sort" class="select-box">
                                            {{-- <option selected="selected" value="">Sort By: Best Selling</option> --}}
                                            <option value="" selected>{{ __("translation.Select")}}</option>
                        ...
                        <div class="toolbar-sorter-2">
                            <div class="select-box-wrapper">
                                <label class="sr-only" for="show-records">{{ __("translation.Show Records Per Page")}}</label>
                                <select class="select-box" id="show-records">
                                    <option selected="selected" value="">{{ __("translation.Showing")}}: {{ count($categoryProducts) }}</option>
                                    <option value="">{{ __("translation.Showing")}}: {{ __("translation.All")}}</option>
                                </select>
                            </div>
                        </div>

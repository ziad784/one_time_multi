...
@section('content')
    ...
    {{-- <ul class="bread-crumb">
        <li class="has-separator">
            ...
            <a href="{{ url('/') }}">{{ __("translation.Home")}}</a>
        </li>
        <li class="is-marked">
            <a href="javascript:;">{{ __("translation.Detail")}}</a>
        </li>
    </ul> --}}
                    ...
                    <div class="all-information-wrapper">
                        ...
                        @if (Session::has('success_message')) <!-- Check AdminController.php, updateAdminPassword() method -->
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                ...
                                <strong>{{ __("translation.Success")}}:</strong> @php echo Session::get('success_message') @endphp       {{-- Displaying Unescaped Data: https://laravel.com/docs/9.x/blade#displaying-unescaped-data --}}
                        ...
                        <div class="section-1-title-breadcrumb-rating">
                            ...
                            <ul class="bread-crumb">
                                <li class="has-separator">
                                    <a href="{{ url('/') }}">{{ __("translation.Home")}}</a> {{-- Home --}}
                                </li>
                                <li class="has-separator">
                        ...
                        <div class="section-2-short-description u-s-p-y-14">
                            <h6 class="information-heading u-s-m-b-8">{{ __("translation.Description")}}:</h6>
                        ...
                        <div class="section-3-price-original-discount u-s-p-y-14">
                            ...
                            <span class="getAttributePrice">{{-- this <span> will be used by jQuery for getting the respective `price` and `stock` depending on the selected `size` in the <select> box (through the AJAX call). Check front/js/custom.js --}}
                                ...
                                @if ($getDiscountPrice > 0) {{-- if there's a discount on the product price --}}
                                    <div class="price">
                                        <h4><span class="real_currency">ريال</span>{{ $getDiscountPrice }}</h4>
                                    </div>
                                    <div class="original-price">
                                        <span>Original Price:</span>
                                        <span><span class="real_currency">ريال</span>{{ $productDetails['product_price'] }}</span> {{-- the product original price (without discount) --}}
                                    </div>
                                @else {{-- if there's no discount on the product price --}}
                                    <div class="price">
                                        <h4><span class="real_currency">ريال</span>{{ $productDetails['product_price'] }}</h4> {{-- the product original price (without discount) --}}
                                    </div>
                                @endif
                        ...
                        <div class="section-4-sku-information u-s-p-y-14">
                            <h6 class="information-heading u-s-m-b-8">{{ __("translation.Information")}}:</h6>
                            <div class="left">
                                <span>{{ __("translation.Product Code")}}:</span>
                                <span>{{ $productDetails['product_code'] }}</span>
                            </div>
                            <div class="left">
                                <span>{{ __("translation.Product Color")}}:</span>
                                <span>{{ $productDetails['product_color'] }}</span>
                            </div>
                            <div class="availability">
                                <span>{{ __("translation.Availability")}}:</span>


                                @if ($totalStock > 0)
                                    <span>{{ __("translation.In Stock")}}</span>
                                @else
                                    <span style="color: red">{{ __("translation.Not Available")}}</span>
                                @endif
                            ...
                            @if ($totalStock > 0)
                                <div class="left">
                                    <span>{{ __("translation.Only")}}:</span>
                                    <span>{{ $totalStock }} {{ __("translation.left")}}</span>
                                </div>
                            @endif
                        ...
                        <form action="{{ url('cart/add') }}" method="Post" class="post-form">
                            ...
                            <div class="section-5-product-variants u-s-p-y-14">
                                ...
                                @if (count($groupProducts) > 0) {{-- if there's a value for the `group_code` column (in `products` table) for the currently viewed product --}}
                                    <div>
                                        <div><strong>{{ __("translation.Product Colors")}}</strong></div>
                                ...
                                <div class="sizes u-s-m-b-11" style="margin-top: 20px">
                                    ...
                                    <div class="size-variant select-box-wrapper">
                                        <select class="select-box product-size" id="getPrice" product-id="{{ $productDetails['id'] }}" name="size" > {{-- Check front/js/custom.js file --}}
                                            ...
                                            <option value="">{{ __("translation.Select Size")}}</option>
                            ...
                            <div class="section-6-social-media-quantity-actions u-s-p-y-14">
                                ...
                                <div class="quantity-wrapper u-s-m-b-22">
                                    <span>{{ __("translation.Quantity")}}:</span>
                                    <div class="quantity"> 
                                        <input class="quantity-text-field" min="1" id="quantity_inp2" onchange="Math.min(Math.max(document.getElementById("quantity_inp2").value, 1), 999)" type="number" name="quantity" value="1">
                                    </div>
                                </div>
                                <div>
                                    <button class="button button-outline-secondary" type="submit">{{ __("translation.Add to cart")}}</button>
                                    <button class="button button-outline-secondary far fa-heart u-s-m-l-6"></button>
                                    <button class="button button-outline-secondary far fa-envelope u-s-m-l-6"></button>
                                    <button class="button button-outline-secondary" style="margin-left: 10px"><a href="{{'/vendorprofile/'.$productDetails["vendor_id"]}}">{{ __("translation.View Vendor")}}</a></button>
                    ...
                    <div class="detail-tabs-wrapper u-s-p-t-80">
                        <div class="detail-nav-wrapper u-s-m-b-30">
                            <ul class="nav single-product-nav justify-content-center">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#video">{{ __("translation.Product Video")}}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#detail">{{ __("translation.Product Details")}}</a>
                                </li>
                                <li class="nav-item">
                                    {{-- <a class="nav-link" data-toggle="tab" href="#review">Reviews (15)</a> --}}
                                    <a class="nav-link" data-toggle="tab" href="#review">{{ __("translation.Reviews")}} {{ count($ratings) }}</a>
                                </li>
                            </ul>
                        </div>
...
">
                                    ...
                                    @else
                                            {{ __("translation.Product Video does not exist")}}
                                    @endif
                            ...
                            <div class="tab-pane fade" id="detail">
                                <div class="specification-whole-container">
                                    <div class="spec-table u-s-m-b-50">
                                        <h4 class="spec-heading">{{ __("translation.Product Details")}}</h4>
                                        <table>
                                    ...
                                    <div class="row r-1 u-s-m-b-26 u-s-p-b-22">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="total-score-wrapper">
                                                <h6 class="review-h6">{{ __("translation.Average Rating")}}</h6>
                                                <div class="circle-wrapper">
                                                    <h1>{{ $avgRating }}</h1>
                                                </div>
                                                <h6 class="review-h6"{{ __("translation.Based on")}}> {{ count($ratings) }} {{ __("translation.Reviews")}}</h6>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <form method="POST" action="{{ url('add-rating') }}" name="formRating" id="formRating">
                                                ...
                                                <div class="your-rating-wrapper">
                                                    <h6 class="review-h6">{{ __("translation.Your Review matters")}}.</h6>
                                                    <h6 class="review-h6">{{ __("translation.Have you used this product before")}}?</h6>
                                                    <div class="star-wrapper u-s-m-b-8">
                                                        ...
                                                        <button class="button button-outline-secondary">{{ __("translation.Submit Review")}}</button>
                                                    {{-- </form> --}}
                                                </div>
                                            </form>
            ...
            <div class="detail-different-product-section u-s-p-t-80">
                ...
                <section class="section-maker">
                    <div class="container">
                        <div class="sec-maker-header text-center">
                            <h3 class="sec-maker-h3">{{ __("translation.Similar Products")}}</h3>
                        </div>
                                    ...
                                    <div class="item">
                                        <div class="image-container">
                                            ...
                                            <div class="item-action-behaviors">
                                                <a class="item-quick-look" data-toggle="modal" href="#quick-view">{{ __("translation.Quick Look")}}</a>
                                                <a class="item-mail" href="javascript:void(0)">{{ __("translation.Mail")}}</a>
                                                <a class="item-addwishlist" href="javascript:void(0)">{{ __("translation.Add to Wishlist")}}</a>
                                                <a class="item-addCart" href="javascript:void(0)">{{ __("translation.Add to Cart")}}</a>
                                            </div>
                                        </div>
                ...
                <section class="section-maker" style="margin-top: 25px">
                    <div class="container">
                        <div class="sec-maker-header text-center">
                            <h3 class="sec-maker-h3">{{ __("translation.Recently Viewed Products")}}</h3>
                        </div>
                        <div class="slider-fouc">
                            <div class="products-slider owl-carousel" data-item="4">

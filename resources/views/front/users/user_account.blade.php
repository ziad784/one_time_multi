    ...
    {{-- <div class="page-style-a">
        <div class="container">
            <div class="page-intro">
                <h2>{{ __("translation.My Account")}}</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login-wrapper">
                        <h2 class="account-h2 u-s-m-b-20" style="font-size: 18px">{{ __("translation.Update Contact Details")}}</h2>
                        ...
                        <form id="accountForm" action="javascript:;" method="post"> {{-- We need to deactivate the 'action' HTML attribute (using    'javascript:;'    ) as we'r going to submit using an AJAX call. Check front/js/custom.js --}}
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-name">{{ __("translation.Name")}}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-address">{{ __("translation.Address")}}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-city">{{ __("translation.City")}}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-state">{{ __("translation.State")}}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-country">{{ __("translation.Country")}}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-pincode">{{ __("translation.Pincode")}}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="u-s-m-b-30">
                                <label for="user-mobile">{{ __("translation.Mobile")}}
                                    <span class="astk">*</span>
                                </label>
                            ...
                            <div class="m-b-45">
                                <button class="button button-outline-secondary w-100">{{ __("translation.Update")}}</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="reg-wrapper">
                        <h2 class="account-h2 u-s-m-b-20" style="font-size: 18px">{{ __("translation.Update Password")}}</h2>
                        ...
                        <form id="passwordForm" action="javascript:;" method="post"> {{-- We need to deactivate the 'action' HTML attribute (using    'javascript:;'    ) as we'r going to submit using an AJAX call. Check front/js/custom.js --}}
                            ...
                            <div class="u-s-m-b-30">
                                <label for="current-password">{{ __("translation.Current Password")}}
                                    <span class="astk">*</span>
                                </label>
                                <input type="password" id="current-password" class="text-field" placeholder="{{ __("translation.Current Password")}}" name="current_password">
                            ...
                            <div class="u-s-m-b-30">
                                <label for="usermobile">{{ __("translation.New Password")}}
                                    <span class="astk">*</span>
                                </label>
                                <input type="password" id="new-password" class="text-field" placeholder="{{ __("translation.New Password")}}" name="new_password">
                            ...
                            <div class="u-s-m-b-30">
                                <label for="useremail">{{ __("translation.Confirm Password")}}
                                    <span class="astk">*</span>
                                </label>
                                <input type="password" id="confirm-password" class="text-field" placeholder="{{ __("translation.Confirm Password")}}" name="confirm_password">
                            ...
                            <div class="u-s-m-b-45">
                                <button class="button button-primary w-100" style="background-color: black">{{ __("translation.Update")}}</button>
                            </div>
                        </form>
                    </div>
                </div>

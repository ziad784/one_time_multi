            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login-wrapper">
                        <h2 class="account-h2 u-s-m-b-20">{{ __("translation.Forgot Password")}}?</h2>
                                ...
                                <div class="group-2 text-right">
                                    <div class="page-anchor">
                                        <a href="{{ url('user/login-register') }}">
                                            <i class="fas fa-circle-o-notch u-s-m-r-9"></i>{{ __("translation.Back to Login")}}
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="m-b-45">
                                <button type="submit" class="button button-outline-secondary w-100">{{ __("translation.Submit")}}</button>
                            </div>
                        </form>
                    </div>
                </div>

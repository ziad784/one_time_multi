...
<div class="mini-cart-wrapper">
    <div class="mini-cart">
        ...
        <ul class="mini-cart-list">
            ...
            @foreach ($getCartItems as $item) {{-- $getCartItems is passed in from cart() method in Front/ProductsController.php --}}
                ...
                <li class="clearfix">
                    ...
                    <span class="mini-item-price"><span class="real_currency">ريال</span>{{ $getDiscountAttributePrice['final_price'] }}</span>
        ...
        <div class="mini-shop-total clearfix">
            <span class="mini-total-heading float-left">{{ __("translation.Total")}}:</span>
            <span class="mini-total-price float-right"><span class="real_currency">ريال</span>{{ $total_price }}</span>
        </div>
        <div class="mini-action-anchors">
            <a href="{{ url('cart') }}"     class="cart-anchor">{{ __("translation.View Cart")}}</a>
            <a href="{{ url('checkout') }}" class="checkout-anchor">{{ __("translation.Checkout")}}</a>
        </div>
    </div>
</div>
<!-- Mini Cart /- -->

...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">المنتجات</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">اضافت منتج جديد</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="card-title">اضافت منتج جديد</h5>
            <hr/>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">رمز المنتج</label>
                                ...
                                <div class="mb-3">
                                    <label for="inputProductDescription" class="form-label">الوصف المبسط</label>
                                ...
                                <div class="mb-3">
                                    <label for="inputProductLongDescription" class="form-label"> الوصف المفصل</label>
                                ...
                                <div class="mb-3">
                                    <label for="inputProductQuantity" class="form-label">كميت المنتج</label>
                        ...
                        <div class="col-lg-4">
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="inputProductType" class="form-label">المصنع المنتج</label>
                                        <select name="brand_id" class="form-select" id="inputProductType">
                                            <option>اختر المصنع</option>
                                    ...
                                    <div class="col-12">
                                        <label for="inputVendor" class="form-label">نوع المنتج</label>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="gridCheck">متاح</label>
                                    </div>
                                    <div class="form-check">
                                        <input name="hot_deal" class="form-check-input" type="checkbox"
                                               id="gridCheck2">
                                        <label class="form-check-label" for="gridCheck2">الاكثر طلبا </label>
                                    ...
                                    <div class="form-check">
                                        <input name="featured_product" class="form-check-input" type="checkbox"
                                               id="gridCheck3">
                                        <label class="form-check-label" for="gridCheck3">منتج معروض</label>
                                    </div>
                                    <div class="form-check">
                                        <input name="special_offer" class="form-check-input" type="checkbox"
                                               id="gridCheck4">
                                        <label class="form-check-label" for="gridCheck4">عرض مميز</label>
                                    ...
                                    <div class="form-check">
                                        <input name="special_deal" class="form-check-input" type="checkbox"
                                               id="gridCheck5">
                                        <label class="form-check-label" for="gridCheck5">صفقه مميزه</label>
                                    </div>

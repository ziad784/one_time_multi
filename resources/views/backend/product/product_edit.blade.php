...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">المنتج</div>
        <div class="ps-3">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="mb-3">
                                    <label for="inputProductQuantity" class="form-label">كميه المنتج</label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label">الاساسي</label>
                        ...
                        <div class="col-lg-4">
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="inputProductType" class="form-label">مصنع المنتج</label>
                                    ...
                                    <div class="col-12">
                                        <label for="inputVendor" class="form-label">فئه المنتج</label>
                                        <select class="form-select" id="inputVendor" name="sub_category_id">
                                            <option>اختر الفئه</option>

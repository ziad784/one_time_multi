        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page">لائحه المنتجات</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="ms-auto" style="margin-bottom: 20px">
                    @if(Auth::user()->role == "vendor")
                        <a href="add_product" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                            <i class="bx bxs-plus-square"></i>اضافت منتج جديد</a></div>
                @endif
                        ...
                        <tr>
                                    ...
                                    <div class="form-check form-switch">
                                        @if($item->product_status)
                                            <input name="de_activate" class="btn btn-outline-danger" type="submit"
                                                   value="تعطيل" @if(Auth::user()->role == 'admin') disabled @endif>
                                        @else
                            ...
                            <td>
                                <button type="button" class="btn btn-primary btn-sm radius-30 px-4"
                                        ...
                                        data-bs-target="#exampleFullScreenModal-{{$item->product_id}}">عرض التفاصيل
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="card-body">
                                                                ...
                                                                <dl class="row">
                                                                    ...
                                                                    <dt class="col-sm-3">الكميه</dt>
                                                                    <dd class="col-sm-9">{{$item->product_quantity}}

                                                                    <dt class="col-sm-3">شعرات</dt>
                                                                    <dd class="col-sm-9">
                                                                    ...
                                                                    <dt class="col-sm-3">الحاله</dt>
                                                                    <dd class="col-sm-9">
                                                                        @if($item->product_status)
                                                                            <span class="badge rounded-pill
                                                                            bg-success">تفعيل</span>
                                                                        @else
                                                                            <span class="badge rounded-pill
                                                                            bg-danger">تعطيل</span>
                                                                        @endif
                                                                    </dd>
                                                                </dl>
                                                            </div>

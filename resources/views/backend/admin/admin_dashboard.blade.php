...
@section('content')
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-0">متابعين الفيس بوك</h6>
                            <!-- <h6 class="mb-0">Facebook Followers</h6> -->
                            <small class="mb-0">22.14% <i class='bx bxs-up-arrow align-middle me-1'></i>منذ الاسبوع الاخير</small>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <small class="mb-0">32.15% <i class='bx bxs-up-arrow align-middle me-1'></i>منذ الاسبوع الاخير</small>
                        </div>
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-0">مشتركين اليوتيوب</h6>
                            <small class="mb-0">58.24% <i class='bx bxs-up-arrow align-middle me-1'></i>منذ الاسبوع الاخير</small>
                        </div>
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            ...
                            <div class="progress-wrapper mb-4">
                                <p>الملفات <span class="float-right">12GB</span></p>
    ...
    <div class="card radius-10">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div>
                    <h5 class="mb-0">ملخص الطلابات</h5>
            ...
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tr>
                        ...
                        <td>$96.00</td>
                        <td>
                            <div class="badge rounded-pill bg-light-success text-success w-100">تام</div>
                        </td>
                        <td>
                            <div class="d-flex order-actions">	<a href="javascript:;" class=""><i class="bx bx-cog"></i></a>
                                <a href="javascript:;" class="ms-4"><i class="bx bx-down-arrow-alt"></i></a>

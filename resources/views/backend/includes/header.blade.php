        ...
        <nav class="navbar navbar-expand">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:;">
                                <div class="msg-header">
                                    <p class="msg-header-title">الاشعرات</p>

                                    <p id="mark-as-read" class="msg-header-clear ms-auto" >قراء الكل</p>
                                </div>
                            </a>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                   role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img style="object-fit: cover" src="{{!empty($authData->photo) ?
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" href="profile"><i class="bx bx-user"></i><span>الحساب</span></a>
                    </li>

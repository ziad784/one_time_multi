...
<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        ...
        {{-- <div>
            <h4 class="logo-text"> إبداع الماسي </h4>
        </div> --}}
    ...
    <ul class="metismenu" id="menu">
        <li class="menu-label">المستخدم</li>
        <li>
        ...
        @if($role === 'admin')
            <li>
                <a  href="{{route('admin-vendor-list')}}" style="cursor: pointer">
                    ...
                    <div class="menu-title">البائعون</div>
                </a>
        ...
        @if($status)
            ...
            <li>
                <a class="has-arrow" style="cursor: pointer">
                    ...
                    <div class="menu-title">الفئات</div>
                </a>
                <ul>
                    <li> <a href="{{route('category')}}"><i class="bx bx-right-arrow-alt"></i>اظهار الكل</a>
                    </li>
                    <li> <a href="{{route('category-add')}}"><i class="bx bx-right-arrow-alt"></i>اضافت فئه</a>
                    </li>
                </ul>
            </li>
            <li>
                <a class="has-arrow" style="cursor: pointer">
                    ...
                    <div class="menu-title">فئات فرعيه</div>
                </a>
                <ul>
                    <li> <a href="{{route('sub-category')}}"><i class="bx bx-right-arrow-alt"></i>اظهار الكل</a>
                    </li>
                    <li> <a href="{{route('sub-category-add')}}"><i class="bx bx-right-arrow-alt"></i> اضافت فئات فرعيه
                            </a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    <li> <a href="{{route($role . '-product')}}"><i class="bx bx-right-arrow-alt"></i>اظهار الكل</a>
                    </li>

                    @if ($role != "admin")
                    <li> <a href="{{route('vendor-product-add')}}"><i class="bx bx-right-arrow-alt"></i>اضافت منتج
                    </a>
            </li>
                    @endif

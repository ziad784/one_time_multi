...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">الفئه الفرعيه</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="{{route($role . '-profile')}}"><i class="bx
                    bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page">لائحه الفئه الفرعيه</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <div class="ms-auto" style="margin-bottom: 20px">
                    <a href="add_sub_category" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                        <i class="bx bxs-plus-square"></i>اضافت الفئه الفرعيه</a></div>

                <table id="data_table" class="table table-striped table-bordered">
                    <thead>
                    <tr>
                        <th>اسم الفئه الفرعيه</th>
                        <th>سبيكة الفئة الفرعيه</th>
                        <th>الفئه المتصله</th>
                        <th>عرض التفاصيل</th>
                        <th>الافعال</th>
                    </tr>
                    ...
                    @foreach ($item["categories"] as $cate)
                        ...
                        <tr>
                            ...
                            <td>{{$cate->sub_category_slug}}</td>
                            <td>{{$item->name}}</td>
                            <td>
                                <button type="button" class="btn btn-primary btn-sm radius-30 px-4"
                                        data-bs-toggle="modal"
                                        data-bs-target="#exampleVerticallycenteredModal-{{$item->sub_category_id}}">عرض التفاصيل
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">تفاصيل الفئه الفرعيه</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                $item->sub_category_image)}}"
                                                     class="card-img-top" style="max-width: 300px; margin-left:
                                                         10px">
                                                <div class="card-body">
                                                    <h5 class="card-title">اسم الفئه الفرعيه : <span style="font-weight:
                                                         lighter">{{$item->sub_category_name}}</span></h5>
                                                    <h5 class="card-title">سبيكة الفئة الفرعيه : <span style="font-weight:
                                                         lighter">{{$item->sub_category_slug}}</span></h5>
                                                    <h5 class="card-title">اسم الفئه : <span style="font-weight:
                                ...
                                <div class="d-flex order-actions">
                                    ...
                                    <div class="modal fade" id="exampleFullScreenModal-{{$item->sub_category_id}}"
                                        ...
                                        <div class="modal-dialog modal-fullscreen">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">تعديل الفئه الفرعيه</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            ('sub-category-update')
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col-sm-3">
                                                                        <h6 class="mb-0">اسم الفئه الفرعيه</h6>
                                                                    </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col-sm-3">
                                                                        <h6 class="mb-0">الفئه المتصله</h6>
                                                                    </div>
                                                                    <div class="col-sm-9 text-secondary">
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col-sm-3">
                                                                        <h6 class="mb-0">صوره الفئه الفرعيه</h6>
                                                                    </div>
                                                                    <div class="col-sm-9 text-secondary">
                                        ...
                                        <div class="modal fade" id="exampleDangerModal-{{$item->sub_category_id}}"
                                            ...
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content bg-danger">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title text-white">متأكد ?</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        ('remove_sub_category/{{$item->sub_category_id}}');"
                                                                class="btn btn-dark">تأكيد</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

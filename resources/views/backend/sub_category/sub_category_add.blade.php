...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page">اضافت الفئه الفرعيه جديده</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="d-flex align-items-center mb-3">اضافت الفئه الفرعيه</h4>
            <br>

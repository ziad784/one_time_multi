                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="phone_number" type="text" class="form-control"
                                               value="{{$data->phone_number}}" placeholder="رقم الهاتف" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="address" type="text"
                                               class="form-control"
                                               value="{{$data->address}}" placeholder="عنوانك"/>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="password_form" action="{{route('admin-profile-password-update')}}"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">كلمه المرور الحليه</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">كلمه المرور الجديده</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary">

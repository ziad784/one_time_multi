...
@section('content')
        ...
        <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show py-2">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    ...
                    <div class="text-white">انتظر حتي يفعل حسابك المسئول</div>
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">المستخدم</div>
        <div class="ps-3">
        ...
        <div class="main-body">
            <div class="row">
                            ...
                            <div class="d-flex flex-column align-items-center text-center">
                                <form id="profile_image" method="POST" action="{{route('vendor-profile-image-update')
                                    ...
                                    <img id="show_image" src="{{!empty($data->photo) ?
                                         ...
                                         alt="User Image"
                                         class="rounded-circle p-1 bg-primary" width="110" height="110" style="object-fit: cover">
                                    <div class="mt-3">
                                        <h4>{{$data->name}}</h4>
                                        <label for="file-upload" class="btn btn-outline-primary"
                                            ...
                                            <i class="bx bxs-cloud-upload"></i>رفع صوره
                                        </label>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="d-flex align-items-center mb-3">بينات المستخدم</h4>
                            <br>
                            <form id="info_form" action="{{route('vendor-profile-info-update')}}" method="POST"
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">تاريخ التسجيل</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="d-flex align-items-center mb-3">تغير كلمه المرور</h4>
                                    <br>
                                    <form id="password_form" action="{{route('vendor-profile-password-update')}}"
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">كلمه المرور الحاليه</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">كلمه مرور جديده</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">تأكيد كلمه المرور</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary">

    ...
    @if(!$status)
        <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show py-2">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    <h6 class="mb-0 text-white">حسابك غير مفعل</h6>
                    <div class="text-white">انتظر المسئول حتي يفعل حسابك</div>
            ...
            <div class="card radius-10 bg-gradient-deepblue">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center text-white">
                        <p class="mb-0">اجمالي الطلابات</p>
        ...
        <div class="col-12 col-lg-8 col-xl-8 d-flex">
            <div class="card radius-10 w-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">زوار الموقع<</h6>
                        </div>
                        <div class="font-22 ms-auto"><i class="bx bx-dots-horizontal-rounded"></i>
                        </div>
                    </div>
                    <div class="d-flex align-items-center ms-auto font-13 gap-2 my-3">
                        <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #14abef"></i>زوار جدد</span>
                        <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #ade2f9"></i>زوار قدام</span>
                    </div>
                ...
                <div class="row row-cols-1 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top">
                    <div class="col">
                        <div class="p-3">
                            ...
                            <small class="mb-0">اجمالي الزوار <span> <i class="bx bx-up-arrow-alt align-middle"></i> 2.43%</span></small>
                        </div>
                    </div>
                    <div class="col">
                        <div class="p-3">
                            <h5 class="mb-0">15:48</h5>
                            <small class="mb-0">مده الزياره <span> <i class="bx bx-up-arrow-alt align-middle"></i> 12.65%</span></small>
                        </div>
                    </div>
                    <div class="col">
                        <div class="p-3">
                            <h5 class="mb-0">245.65</h5>
                            <small class="mb-0">الصفحات المزاره <span> <i class="bx bx-up-arrow-alt align-middle"></i> 5.62%</span></small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-lg-4 col-xl-4 d-flex">
            <div class="card radius-10 overflow-hidden w-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">المبيعات الاسبوعيه</h6>
                        </div>
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-0">متبيعين الفيس بوك</h6>
                            <small class="mb-0">22.14% <i class='bx bxs-up-arrow align-middle me-1'></i>منذ الاسبوع الفائت</small>
                        </div>
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-0">التويتات</h6>
                            <small class="mb-0">32.15% <i class='bx bxs-up-arrow align-middle me-1'></i>منذ الاسبوع الفائت</small>
                        </div>
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-0">مشتريكين اليوتيوب</h6>
                            <small class="mb-0">58.24% <i class='bx bxs-up-arrow align-middle me-1'></i>منذ الاسبوع الفائت</small>
                        </div>
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <div>
                            <h6 class="mb-0">مناطق البيع العالميه</h6>
                        </div>
                        <div class="font-22 ms-auto text-white"><i class="bx bx-dots-horizontal-rounded"></i>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="card radius-10">
                        <div class="card-body text-center">
                            ...
                            <hr>
                            <p class="mb-0 small-font text-center">3.4% <i class="zmdi zmdi-long-arrow-up"></i> منذ امس</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="card radius-10">
                        <div class="card-body">
                            ...
                            <div class="progress-wrapper mb-4">
                                <p>الملافات <span class="float-right">12GB</span></p>
                            ...
                            <div class="progress-wrapper mb-4">
                                <p>الصور <span class="float-right">10GB</span></p>
                                <div class="progress" style="height:5px;">
                            ...
                            <div class="progress-wrapper mb-4">
                                <p>الرسائل <span class="float-right">5GB</span></p>
                                <div class="progress" style="height:5px;">
        ...
        <div class="col-12 col-lg-6 col-xl-4 d-flex">
            <div class="card radius-10 overflow-hidden w-100">
                <div class="card-body">
                    ...
                    <small>1.4% <i class="zmdi zmdi-long-arrow-up"></i> منذ الشهر الفائت</small>
                    <hr>
                    <p> اجمالي المبيعات</p>
                    <h4 class="mb-0">$87,493</h4>
                    <small>5.43% <i class="zmdi zmdi-long-arrow-up"></i> منذ الشهر الفائت</small>
                    <div class="mt-5">
        ...
        <div class="col-12 col-lg-6 col-xl-8 d-flex">
            <div class="card radius-10 w-100">
                <div class="card-header border-bottom bg-transparent">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-0">تقيم المتسخدمين</h6>
                        </div>
                        <div class="font-22 ms-auto"><i class="bx bx-dots-horizontal-rounded"></i>
                        </div>
                    </div>

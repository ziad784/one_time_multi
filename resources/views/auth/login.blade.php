                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                <div class="text-center">
                                    <!-- <h3 class="">Sign in</h3> -->
                                    <h3 class="">{{ __("translation.Login")}}</h3>
                                    <!-- <p>Don't have an account yet? <a href="/register">Sign up here</a> -->
                                    <p>{{ __("translation.already have an account")}}? <a href="/admin/register">{{ __("translation.Register here")}}</a>
                                    </p>
                                </div>
                                {{-- <div class="d-grid">
                          ...
                          <img class="me-2" src="{{asset('backend_assets')}}/images/icons/search.svg" width="16"
                               alt="Image
                          Description">
                          <span>سجل من جوجل</span>
											</span>
                                    </a>
                                </div> --}}
                                <!-- <div class="login-separater text-center mb-4"> <span>OR SIGN IN WITH USERNAME</span> -->
                                {{-- <div class="login-separater text-center mb-4"> <span>او سجل بأسم المستخدم</span>
                                    <hr/>
                                </div> --}}
                                <div class="form-body">
                                    <form id="login_form" class="row g-3" method="POST" action="{{url('admin/login')
                                    }}">
                                        @csrf

                                        <div class="col-sm-12">
                                            <label for="inputUserName" class="form-label">{{ __("translation.Username")}}</label>
                                            <input name="email" type="text" class="form-control" id="inputUserName"
                                                   placeholder="{{ __("translation.Username")}}" autocomplete="username"
                                                   autofocus
                                                   required>
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>{{ __("translation.Login")}}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>

...
<html lang="en">
    <head>
        ...
        <title>{{ __("translation.Admin Panel")}}</title>
        <!-- plugins:css -->
                    ...
                    <div class="row w-100 mx-0">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                                <h4>{{ __("translation.Hello! let's get started")}}</h4>
                                <h6 class="font-weight-light">{{ __("translation.Sign in to continue")}}.</h6>
                                ...
                                <form class="pt-3" action="{{ url('admin/login') }}" method="post">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        {{-- My code: --}}
                                        <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">{{ __("translation.SIGN IN")}}</button>
                                    ...
                                    <div class="my-2 d-flex justify-content-between align-items-center">
                                        <div class="form-check">
                                            ...
                                            {{ __("translation.Keep me signed in")}}
                                            </label>
                                        </div>
                                    </div>
                                </form>

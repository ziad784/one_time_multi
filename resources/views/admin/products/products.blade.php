                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Error:</strong>  Please create vendor busniess first
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                                ...
                                <table id="products" class="table table-bordered"> {{-- using the id here for the DataTable --}}
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __("translation.Category")}}</th> {{-- Through the relationship --}}
                                            <th>{{ __("translation.Section")}}</th>  {{-- Through the relationship --}}
                                            <th>{{ __("translation.Added by")}}</th> {{-- Through the relationship --}}

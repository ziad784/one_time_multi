        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">{{ __("translation.Shipping Charges")}}</h4>
                                ...
                                <table id="shipping" class="table table-bordered"> {{-- using the id here for the DataTable --}}
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __("translation.Rate (0g to 500g)")}}</th>
                                            <th>{{ __("translation.Rate (501g to 1000g)")}}</th>
                                            <th>{{ __("translation.Rate (1001g to 2000g)")}}</th>
                                            <th>{{ __("translation.Rate (2001g to 5000g)")}}</th>
                                            <th>{{ __("translation.Rate (Above 5000g)")}}</th>

...
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h4 class="card-title">{{ __("translation.Attributes")}}</h4> {{-- meaning Product attributes --}}
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card" style="max-width: 60%">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">{{ __("translation.Add Attributes")}}</h4>
                            ...
                            <form class="forms-sample" action="{{ url('admin/add-edit-attributes/' . $product['id']) }}" method="post">
                                ...
                                <div class="form-group">
                                    <div class="field_wrapper">
                                        <div>
                                            <input type="text" name="size[]"  placeholder="{{ __("translation.Size")}}"  style="width:100px" required> {{-- !! Note that the "name" HTML attribute is an ARRAY (using SQUARE BRAKETS [] !!) --}}
                                            ...
                                            <input type="text" name="price[]" placeholder="{{ __("translation.Price")}}" style="width:100px" required> {{-- !! Note that the "name" HTML attribute is an ARRAY (using SQUARE BRAKETS [] !!) --}}
                                            <input type="text" name="stock[]" placeholder="{{ __("translation.Stock")}}" style="width:100px" required> {{-- !! Note that the "name" HTML attribute is an ARRAY (using SQUARE BRAKETS [] !!) --}}
                                            <a href="javascript:void(0);" class="add_button" title="Add Attributes">{{ __("translation.Add")}}</a> {{-- Add another 4 input fields like the former --}}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <h4 class="card-title">{{ __("translation.Product Attributes")}}</h4>
                            ...
                            <form method="post" action="{{ url('admin/edit-attributes/' . $product['id']) }}">
                                ...
                                <button type="submit" class="btn btn-primary">{{ __("translation.Update Attributes")}}</button>
                            </form>
                        </div>
                    </div>
                </div>

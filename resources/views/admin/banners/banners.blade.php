                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ url('admin/add-edit-banner') }}" style="max-width: 150px; float: right; display: inline-block" class="btn btn-block btn-primary">{{ __("translation.Add Banner")}}</a>
                                ...
                                <table id="banners" class="table table-bordered"> {{-- using the id here for the DataTable --}}
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __("translation.Link")}}</th>
                                            <th>{{ __("translation.Title")}}</th>
                                            <th>{{ __("translation.Alt")}}</th>

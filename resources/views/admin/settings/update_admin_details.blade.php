        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">{{ __("translation.Admin Settings")}}</h3>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">{{ __("translation.Update Admin Details")}}</h4>
                            ...
                            <form class="forms-sample" action="{{ url('admin/update-admin-details') }}" method="post" enctype="multipart/form-data"> @csrf <!-- Using the enctype="multipart/form-data" to allow uploading files (images) -->
                                <div class="form-group">
                                    <label>{{ __("translation.Admin Username/Email")}}</label>
                                ...
                                <div class="form-group">
                                    <label>{{ __("translation.Admin Type")}}</label>
                                ...
                                <div class="form-group">
                                    <label for="admin_name">{{ __("translation.Name")}}</label>
                                    <input type="text" class="form-control" id="admin_name" placeholder="{{ __("translation.Enter Name")}}" name="admin_name" value="{{ Auth::guard('admin')->user()->name }}"> {{-- Accessing Specific Guard Instances: https://laravel.com/docs/9.x/authentication#accessing-specific-guard-instances --}}
                                </div>
                                <div class="form-group">
                                    <label for="admin_mobile">{{ __("translation.Mobile")}}</label>
                                    <input type="text" class="form-control" id="admin_mobile" placeholder="{{ __("translation.Enter 10 Digit Mobile Number")}}" name="admin_mobile" value="{{ Auth::guard('admin')->user()->mobile }}" maxlength="10" minlength="10"> {{-- Accessing Specific Guard Instances: https://laravel.com/docs/9.x/authentication#accessing-specific-guard-instances --}}
                                </div>
                                <div class="form-group">
                                    <label for="admin_image">{{ __("translation.Admin Photo")}}</label>
